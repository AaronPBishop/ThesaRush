...
Revision ID: e79d12b78f43
Revises: 
Create Date: 2022-12-29 22:38:23.485955
...
def upgrade():
    ...
    op.create_table('player_challenges',
    ...
    sa.PrimaryKeyConstraint('player_1_id', 'player_2_id', 'challenge_id')
    )
